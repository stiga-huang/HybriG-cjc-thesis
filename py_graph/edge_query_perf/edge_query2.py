...
bar1 = plt.barh(y_pos, titan, height=0.2, align='center', hatch='xx', color='w', edgecolor='black')
bar2 = plt.barh((0.3,), (474,), height=0.2, left=titan[0], align='center', hatch='//', color='w', edgecolor='black')
