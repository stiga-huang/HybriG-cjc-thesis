...
fig, ax = plt.subplots()
rects1 = ax.bar(ind + rect_width, raw, rect_width, color='w', edgecolor='black', hatch='xx')
rects2 = ax.bar(ind + rect_width * 2, scopa, rect_width, color='w', edgecolor='black', hatch='//')
